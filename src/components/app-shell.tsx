...
export function AppShell() {
  ...
  if (session === "participant") return <ParticipantDashboard userName={name} winners={winners} onLogout={() => setSession("landing")} />;
