...
Protmūšio vakarų rezervacijų sistema: septyni stalai, po keturias vietas, dalyvių paskyros, administratoriaus valdymas ir vieši nugalėtojų rezultatai.
...
│       ├── constants.ts              Stalų, vietų ir bendros talpos nustatymai
...
│       └── 202609170002_expand_to_seven_tables.sql
├── tests/
...
│   └── Administratorius
│       ├── Pasirinkti datą → matyti 7 stalus ir jų žaidėjus
...
Administratoriaus ekrane pasirinkite žaidimo datą, kad matytumėte septynis stalus ir jų žaidėjus. Prie užimtos vietos esantis mygtukas „Pašalinti“ atmeta rezervaciją, atlaisvina vietą ir įrašo veiksmą į istoriją. Žaidėjo paskyra išlieka. Istorijoje rodoma iki 100 naujausių veiksmų po 25 viename puslapyje; atidarius istoriją iš bazės pašalinami senesni nei trijų mėnesių įrašai.
